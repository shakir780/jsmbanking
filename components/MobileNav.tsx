...
const MobileNav = ({user}:MobileNavProps) => {
  ...
  <SheetContent side="left" className="border-noce bg-white">
  <Link href="/" className=' cursor-pointer flex items-center gap-1 px-4'>

<Image src="/icons/logo.svg" width={34} height={34} alt="Hoizon logo "/>
<h1 className='text-26 font-ibm-plex-serif font-bold text-black-1'>Horzion</h1>
</Link>
